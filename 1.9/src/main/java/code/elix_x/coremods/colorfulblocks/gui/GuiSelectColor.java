...
public class GuiSelectColor extends GuiScreen {
	...
	public void initGui(){
		...
		buttonList.add(randomB = new GuiButton(0, guiLeft + 7, guiTop + ySize - 3 - 4 - 16, 64, 16, I18n.translateToLocal("guiselectcolor.button.random")));
		buttonList.add(done = new GuiButton(1, guiLeft + xSize - 7 - 64, guiTop + ySize - 3 - 4 - 16, 64, 16, I18n.translateToLocal("guiselectcolor.button.done")));

		GuiTextField oldRt = rT;
		rT = new GuiTextField(0, fontRendererObj, guiLeft + xSize / 2 - 64 / 2, guiTop + ySize - 3 - 4 - 16 - 90 + 6 + 4, 64, 16);
		if(oldRt != null){
		...
		gT = new GuiTextField(0, fontRendererObj, guiLeft + xSize / 2 - 64 / 2, guiTop + ySize - 3 - 4 - 16 - 90 + 6 + 4 + 30, 64, 16);
		if(oldGt != null){
		...
		bT = new GuiTextField(0, fontRendererObj, guiLeft + xSize / 2 - 64 / 2, guiTop + ySize - 3 - 4 - 16 - 90 + 6 + 4 + 30 + 30, 64, 16);
		if(oldBt != null){
	...
	@Override
	protected void mouseClickMove(int x, int y, int which, long timeSinceLastClick){
		super.mouseClickMove(x, y, which, timeSinceLastClick);
	}
