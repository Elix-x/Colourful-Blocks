...
public class ColorfulBlocksBlockColor implements IBlockColor {
	...
	public int colorMultiplier(IBlockState state, IBlockAccess world, BlockPos pos, int tintIndex){
		return world != null && pos != null ? ColoredBlocksManager.getBlockColor(world, state, new code.elix_x.excore.utils.pos.BlockPos(pos), parent != null && tintIndex != Integer.MAX_VALUE ? parent.colorMultiplier(state, world, pos, tintIndex) : -1) : parent.colorMultiplier(state, world, pos, tintIndex);
	}
