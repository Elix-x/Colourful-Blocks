...
public class CustomRenderBlocks extends RenderBlocks{
    ...
    public CustomRenderBlocks(IBlockAccess p_i1251_1_)
    {
    ...
    public boolean renderBlockByRenderType(Block p_147805_1_, int p_147805_2_, int p_147805_3_, int p_147805_4_)
    {
        ...
        else
        {
            ...
            default: return RenderingRegistry.instance().renderWorldBlock(this, blockAccess, p_147805_2_, p_147805_3_, p_147805_4_, p_147805_1_, l);
            }
        }
    }
...
//            GL11.glColor4f(f1 * p_147800_3_, f2 * p_147800_3_, f3 * p_147800_3_, 1.0F);
        ...
        if (j != 0 && j != 31 && j != 39 && j != 16 && j != 26)
        {
            ...
            {
            	RenderingRegistry.instance().renderInventoryBlock(this, p_147800_1_, p_147800_2_, j);
            }
        }
        else
        {
...
//                GL11.glColor4f(p_147800_3_, p_147800_3_, p_147800_3_, 1.0F);
    ...
    public static boolean renderItemIn3d(int p_147739_0_)
    {
        ...
        case 34: return true ;
        case 35: return true ;
        default: return RenderingRegistry.instance().renderItemAsFull3DBlock(p_147739_0_);
        }
    }
